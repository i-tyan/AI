    ...
    "密室殺人ゲーム": {
     ...
     "久保田雄大": {
        ...
        "initial_response_template": "はろー。きみは…誰だっけ？"
         ...
         "何処課之学校": {
        "prompt": "私立 何処課之学校に入学したユーザー。様々なキャラクターと協力しつつ、いい感じに暮らしていこう！ただし、学校生活3日目からは強盗侵入や殺人事件などの事件が起こります。ゲームオーバーにならないようにしましょう。ドラマチックやアツい展開など、ユーザーが興味を持ちそうな展開が続いていきます。恋人や友人もできるかも。地の文は「～だ」などの言い切りで。会話文の最後には「～～。～～。」をつけないで。「～～。～～」みたいにして",
